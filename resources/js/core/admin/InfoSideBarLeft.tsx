...
function InfoSideBarLeft() {
    return (
        <aside className="fixed top-0 left-0 w-64 h-screen bg-[#3B2314] border-r-2 border-[#A08050] z-50 flex flex-col overflow-y-auto">
            <div className="p-7 border-b border-yellow-900/30">
            ...
            <div className="p-3 mt-4">
                ...
                <nav className="space-y-1">
                    ...
                    <a href="#" className="flex items-center gap-3 px-3 py-2 rounded-md text-[#E8D5A3]/70 hover:bg-[#C8AD7F]/10 hover:text-[#E8D5A3] transition-all group">
                        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                        Posts
                        <span className="ml-auto bg-[#6B3F1F] text-[#E8D5A3] text-[11px] px-2 py-0.5 rounded-full border border-[#C8AD7F]/30">12</span>
                    </a>
                    ...
                    <a href="#" className="flex items-center gap-3 px-3 py-2 rounded-md text-[#E8D5A3]/70 hover:bg-[#C8AD7F]/10 hover:text-[#E8D5A3] transition-all">
                        ...
                        Borradores
                        <span className="ml-auto bg-[#6B3F1F] text-[#E8D5A3] text-[11px] px-2 py-0.5 rounded-full border border-[#C8AD7F]/30">4</span>
                    </a>
                </nav>
            </div>
            ...
            <div className="mt-auto p-4 border-t border-[#C8AD7F]/10">
                <div className="flex items-center gap-3 p-2 bg-[#C8AD7F]/10 rounded-lg">
                    <div className="w-9 h-9 rounded-full bg-[#A08050] flex items-center justify-center font- text-white border border-[#C8AD7F]">G</div>
